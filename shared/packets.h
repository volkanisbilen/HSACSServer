...
#define WIZ_HSACS_CLAN			0xD1	// Clan Warehouse Open, In, Out
...
//
#define WIZ_SOUND					0xB5
#define WIZ_VANGUARD			0xB6	//0xB6
#define WIZ_NEW_PACKETB8		0xB8
...
enum HSACSXOpCodes
{
	...
	MESSAGE2,
	CHEST_BLOCKITEM,
	WIZ_ITEM_EXCHANGE_INFO,
	WIZ_HOOK_VISIBLE,
	WIZ_DAILY_REWARD,
	WIZ_GAME_MASTER_MODE,
	WIZ_TARGET_SKILL, 
	WIZ_EVENT_HOOK
};
...
enum MerchantOpcodes
{
	...
	MERCHANT_LIST				= 0x31,
	MERCHANT_EYE_LIST			= 0x32,
	MERCHANT_BUY_LIST_NEW		= 0x51
};

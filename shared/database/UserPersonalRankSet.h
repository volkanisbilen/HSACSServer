...
class CBotPersonalRankSet : public OdbcRecordset
{
public:
	CBotPersonalRankSet(OdbcConnection* dbConnection, UserNameRankMap* pkarusMap, UserNameRankMap* pelmoMap)
		: OdbcRecordset(dbConnection), m_pKarusMap(pkarusMap), m_pElmoMap(pelmoMap) {}

	virtual tstring GetTableName() { return _T("BOT_PERSONAL_RANK"); }
	virtual tstring GetColumns() { return _T("nRank, strRankName, strElmoUserID, strElmoClanName, sElmoKnights, nElmoLoyaltyMonthly, strKarusUserID, strKarusClanName, sKarusKnights, nKarusLoyaltyMonthly, nSalary"); }

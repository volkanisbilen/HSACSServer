...
public:
	...
	virtual tstring GetColumns() { return _T("sIndex, Facebook, FacebookUrl, Discord, DiscordURL, Live, LiveURL, DiscordToken, DiscordTokenID, ResellerURL"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchByte(8, pData->DiscordToken);
		_dbCommand->FetchString(9, pData->DiscordTokenID);

		_dbCommand->FetchString(10, pData->ResellerURL);

...
public:
	...
	virtual tstring GetTableName() { return _T("ITEM1098"); }
#elif(GAME_SOURCE_VERSION == 1534)
	virtual tstring GetTableName() { return _T("ITEM1534"); }
#else
	virtual tstring GetTableName() { return _T("ITEM"); }
#endif

	virtual tstring GetColumns() {
		return _T("Num, Extension, strName, Description, ItemIconID1, ItemIconID2, Kind, Slot, Race, Class, Damage,"
			"minDamage,maxDamage,"

...
const uint8 CTOP		= 46;
const uint8 CEMBLEM		= 47;
const uint8 CTATTOO		= 49; // for me i use 50
const uint8 CFAIRY		= 48;
const uint8 CTALISMAN	= 50;
const uint8 CBAG1		= 51;
const uint8 CBAG2		= 52;
...
const uint8 COSP_EMBLAM		= 5;
const uint8 COSP_TALISMAN	= 9;
const uint8 COSP_FAIRY		= 7;
const uint8 COSP_TATTO		= 8;
const uint8 COSP_BAG1		= 6; // relative bag slot from cospre items
const uint8 COSP_BAG2		= 10; // relative bag slot from cospre items


const uint8 SLOT_MAX = 14;	// 14 equipped item slots
const uint8 HAVE_MAX = 28;	// 28 inventory slots
const uint8 COSP_MAX = 11;	// 11 cospre slots
...
struct	_ITEM_DATA
{
	...
	INLINE uint32 GetNum() { return nNum; }
...
struct PET_DATA
{
	...
	INLINE bool isFamilyAttack() { return sAttackStart; }
	INLINE int16 GetFamilyAttackID() { return sAttackTargetID; }
	INLINE void isFamilyAttackEnd() { sAttackStart = false; sAttackTargetID = -1; }

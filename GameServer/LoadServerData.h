...
typedef CSTLMap <_SOCCER_STATUS_INFO>				TempleSoccerEventRoomList;
typedef CSTLMap <_TEMPLE_EVENT_USER>				TempleEventUserMap;
//typedef CSTLMap <_SOCCER_STARTED_EVENT_USER>		SoccerEventUserMap;
...
typedef CSTLMap <_EVENT_TIMER_SHOW_LIST>				EventTimerShowArray;
...
typedef CSTLMap <_ITEM_RIGHT_CLICK_EXCHANGE>		HShieldSoftwareRightClickExchangeArray;
typedef CSTLMap <_ITEM_RIGHT_EXCHANGE>				HShieldSoftwareRightExchangeArray;
#endif
...
struct LadderPointList { std::string name; uint32 loyalty; LadderPointList(std::string a, uint32 b) { name = a; loyalty = b; } };
...
public:
	...
	typedef	std::vector<LadderPointList> m_sLadderPoint;
	m_sLadderPoint m_sLadderPointList;
	time_t m_sLadderPointTime;
	...
	INLINE bool isCastellanCape() { return m_sCastellanCape; }

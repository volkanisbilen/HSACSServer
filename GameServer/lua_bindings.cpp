...
#define LUA_CLASS CUser
	...
	(
		...
		MAKE_LUA_METHOD(GiveSwitchPremium) //17.12.2020 Switch Premium Yukler Yuklemez 3 ünü birden goruntuluyecek sekilde yeni komut eklendi
...
LUA_WRAPPER_USER_FUNCTION(GiveSwitchPremium); //17.12.2020 Switch Premium Yukler Yuklemez 3 ünü birden goruntuluyecek sekilde yeni komut eklendi
...
LUA_WRAPPER_USER_FUNCTION(SendVisibe);

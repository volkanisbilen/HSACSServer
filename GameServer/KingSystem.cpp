...
void CKingSystem::LoadRecommendList()
{
	...
	g_pMain->m_KnightsRatingArray[m_byNation - 1].m_lock.lock();
	auto m_sKnightsRatingArray = g_pMain->m_KnightsRatingArray[m_byNation - 1].m_UserTypeMap;
	g_pMain->m_KnightsRatingArray[m_byNation - 1].m_lock.unlock();
